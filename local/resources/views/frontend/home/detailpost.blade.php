...
<div class="postdeatailcontent">
                

<div class="pbig slick-slider slick-initialized @if($slugcate=='bao-gia') {{'noneclass'}}@endif" data-slick="{&quot;slidesToShow&quot;: 1,&quot;slidesToScroll&quot;: 1,&quot;arrows&quot;: true,&quot;asNavFor&quot;:&quot;.psmall&quot;,&quot;autoplay&quot;:true}">
    <button class="slick-prev slick-arrow predetail" aria-label="Previous" type="button" style="">Previous</button>
...
<div class="slick-list draggable">
 <div class="owl-carousel owl-theme sliderdetail">
    @if(count($image)>0)
      ...
      <div class="item">
        <img src="{{url('public/backend/post')}}/{{$val}}" alt="">
      </div> 
      @endforeach
    @else
    <div class="item">
        <img src="{{url('public/backend/post')}}/{{$post_detail->post_img}}" alt="">
      </div> 
    @endif
</div>
</div>
...
<button class="slick-next slick-arrow nextdetail" aria-label="Next" type="button" style="">Next</button></div>
...
<div style="text-align: justify;" class="deatilPost">
...
<a class="imgc" href="" target="" title="">
    <img src="{{url('public/backend/block')}}/{{$v->img}}" class=" lazyloaded" alt="" data-src="{{url('public/backend/block')}}/{{$v->img}}">
</a>
@endforeach
