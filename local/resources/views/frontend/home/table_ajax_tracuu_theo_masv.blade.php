...
<table class="table2excel" id="source-html" data-tableName="Test Table 1" style="border: 1px solid black">
  <thead>
    <tr class="top noExl">
      <td colspan="13"> <p>BẢNG KẾT QUẢ HỌC TẬP</p>
         ...
         <tr class="tr_saumoi">
          ...
          <td colspan="6" class="none_right">Khóa học: 2019-2022</td>
         </tr>
         <tr class="tr_saumoi">
...
<button class="exportToExcel btn btn-success" style="margin: 5px; margin-left: 25px;">Lưu file excel </button>
 ...
 <!-- <button id="btn-export" class="btn btn-success" onclick="exportHTML();">Lưu file
        word </button> -->
<script>
    function exportHTML(){
