...
@section('title')
<title>Payment_trans_his_new</title>
@endsection('title')
...
@section('content')
            ...
            <section class="content-header">
                <h3 class="service">
                   ...
                   <li>
                       <a href="javascript::voild(0)">paymentTranHis</a>
                   </li>
                ...
                <div class="row">
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body">
                          <iframe src="http://10.58.244.203:8456/d/asKu3H4Wz/payment_trans_his_new" width="100%" height="1000" frameborder="0"></iframe>
