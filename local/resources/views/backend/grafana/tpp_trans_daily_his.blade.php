...
@section('title')
<title>Tpp_trans_daily_his</title>
@endsection('title')
...
@section('content')
            ...
            <section class="content-header">
                <h3 class="service">
                   ...
                   <li>
                       <a href="javascript::voild(0)">tpp_trans_daily_his</a>
                   </li>
                ...
                <div class="row">
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body">
                          <iframe src="http://10.58.244.203:8456/d/wdNwlXrmz/tpp_trans_daily_his" width="100%" height="1000" frameborder="0"></iframe>
