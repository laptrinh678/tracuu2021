...
@section('title')
<title>Trans-gateway-error</title>
@endsection('title')
...
@section('content')
            ...
            <section class="content-header">
                <h3 class="service">
                   ...
                   <li>
                       <a href="javascript::voild(0)">Trans-gateway-error</a>
                   </li>
                ...
                <div class="row">
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body">
                          <iframe src="http://10.58.244.203:8456/d/WNHSzjnWk/trans-gateway-error" width="100%" height="1000" frameborder="0"></iframe>
