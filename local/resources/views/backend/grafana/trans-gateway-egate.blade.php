...
@section('title')
<title>Trans-gateway-egate</title>
@endsection('title')
...
@section('content')
            ...
            <section class="content-header">
                <h3 class="service">
                   ...
                   <li>
                       <a href="javascript::voild(0)">Trans-gateway-egate</a>
                   </li>
                ...
                <div class="row">
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body">
                          <iframe src="http://10.58.244.203:8456/d/LvPRne7Zz/trans-gateway-egate?orgId=1" width="100%" height="1000" frameborder="0"></iframe>
