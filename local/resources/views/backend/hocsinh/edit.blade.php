				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Ảnh</label>
					<div class="col-sm-9">
						<div id="div_1">
					       ...
					       <input type="file" required="" name="newimg" multiple="true" onchange="previewImg(event);" id="img_file" accept="image/*" value="{{$data_bl_id->img}}">
