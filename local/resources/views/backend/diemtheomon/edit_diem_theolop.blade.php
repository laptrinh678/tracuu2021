            ...
            <section class="content">
                ...
                <div class="row">
                            ...
                            <div class="panel-body">
                               ...
                               <div class="form-group">
                                  ...
                                  <select id="laydanhsachlop" class="form-control select2" name="lophoc" required="">
                                      <option value="">Select value...</option>
                                       @foreach($lophoc as $v)
                                          <option value="{{$v->id}}" selected="@if($data_diem->id_lop==$v->id) {{'selected'}} @endif">{{$v->name}}</option>
                                      @endforeach 
                  ...
                  <div class="row">
									...
									<input type="text" class="form-control" value="{{$v['ma']}}">
									...
									<input type="text" class="form-control" name="diemtrungbinhkiemtra[]" required="" value="{{$v['tb_kt']}}">
									</div>
                  <div class="col-sm-3">
                  <label>Điều kiện thi</label>
                  <select name="dieukienthi[]" id="" required="" class="form-control" >
                
                    <option value="Được thi" @if($v['dieukienthi']=='Được thi'){{'selected'}}@endif>Được thi</option>
                
                    <option value="KĐT" @if($v['dieukienthi']=='KĐT') {{'selected'}}@endif>Không được thi</option>
