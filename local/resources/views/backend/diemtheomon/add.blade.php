                    ...
                    <div class="col-md-12">
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                              ...
                              <input type="text" name="diem_tbkt" class="form-control" placeholder="nhâp điêm trung bình kiểm tra">
                            </div>
                                       <div class="form-group">
                              <label for="email">Điểm thi lần 1</label>
                              <input type="text" name="diemthilan1" class="form-control" placeholder="nhâp điêm thi lân 1">
                            </div>
                            <div class="form-group">
                              <label for="email">Điểm thi lần 2</label>
                              <input type="text" name="diemthilan2" class="form-control" placeholder="nhâp điêm thi lân 2">
                            </div>
