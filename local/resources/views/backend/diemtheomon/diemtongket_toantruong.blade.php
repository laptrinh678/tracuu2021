                        ...
                        <div class="panel panel-primary filterable">
                            <div class="panel-heading clearfix  ">
                                 ...
                                 <div class="panel-title pull-left">
                                    <div class="caption">
                                      <a  style="color: white; font-weight: bold" >
                                             <i class="livicon" data-name="camera" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Danh sách điểm toàn trường
                                        </a>
                                ...
                                <div class="tools pull-right">
                                	<a href="{{url('admin/diemtheomon/diemtongket_dongbo')}}" style="color: white; font-weight: bold">
                                      ...
                                      @foreach($data as $k=>$v)
                                        <tr> 
                                           ...
                                           <!-- <button data="{{$v->id}}" class="btn btn-danger delete"><i class="fa fa-trash" aria-hidden="true"></i></button> 
                                            ...
                                            <td>
                                            Điểm thi:{{$v->diemthilan1}}
                                            <br>
                                            Tổng kết :{{$v->tk_monlan1}}
                                            </td>
                                            <td></td>
