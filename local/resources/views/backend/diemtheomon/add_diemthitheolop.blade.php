...
@section('content')
        <aside class="right-side">
            ...
            <section class="content-header">
                <!--section starts-->
                <h1>THÊM ĐIỂM THI THEO LỚP LẦN 1</h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="index.html">
                    ...
                    <li>
                        <a href="#">Thêm Điểm thi theo lớp</a>
                    </li>
            ...
            <section class="content">
                ...
                <div class="row">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    Thêm điểm thi lớp theo môn lần 1
                                </h3>
                  ...
                  @foreach($arr as $v)
									...
									<input type="text" name="masv[]" class="form-control" value="{{$v['ma']}}" readonly="False">
                   ...
                   @if($v['dieukienthi']!='KĐT')
									<input type="text" class="form-control" name="diemthi[]" value="">
                  <input type="hidden" class="form-control" name="kgdu_dkthi[]" readonly="False" value="Đã thi">
                  @else
                  <input type="hidden" class="form-control" name="diemthi[]" readonly="False" value="0" placeholder="Không đủ điều kiện thi">
