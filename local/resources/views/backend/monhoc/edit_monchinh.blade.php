                            ...
                            <div class="panel-body">
                                <div class="box-body">
                                  ...
                                  <select id="select21" class="form-control select2" name="monhoc" required="">
                                     ...
                                     @foreach($monhoc as $v)
                                          <option value="{{$v->id}}" @if($v->id == $data->id_mon) {{'selected'}} @endif >{{$v->ten}}</option>
                                      @endforeach 
                               ...
                               <div class="form-group">
                                  ...
                                  <select id="select22" class="form-control select2" name="lophoc" required="">
                                     ...
                                     @foreach($lophoc as $v)
                                          <option value="{{$v->id}}" @if($v->id == $data->id_lophoc) {{'selected'}} @endif>{{$v->name}}</option>
                                      @endforeach 
                               ...
                               <div class="form-group hocvienlist">
                                <label for="" class="control-label">
                                  ...
                                  <select id="select23" class="form-control select2" name="id_sv" required="">
                                   ...
                                   <option value="{{$data->id_sv}},{{$data->masv}}"  selected >{{$data->ho_tendem}} {{$data->tensv}} - {{$data->masv}}</option>
                              ...
                              <select name="hocky" id="" class="form-control hocky" required="">
                                ...
                                <option value="1" @if($data->hocky==1) {{'selected'}} @endif >Học Kỳ 1</option>
                                <option value="2" @if($data->hocky==2) {{'selected'}} @endif>Học kỳ 2</option>
                              </select>
                            </div>
                              <div class="form-group">
                              ...
                              <select name="namhoc" id="" class="form-control namhoc" required="">
                                ...
                                <option value="{{$data->namhoc}}" selected >{{$data->namhoc}}</option>
                                ...
                                <option value="2020-2021" >2020-2021</option>
                                    ...
                                    <div class="col-sm-6">
                                       <div class="form-group">
                              <label for="email">Điểm trung bình kiểm tra</label>
                              <input type="text" name="diem_tbkt" class="form-control" value="{{$data->diem_tbkt}}" placeholder="nhâp điêm trung bình kiểm tra">
                            </div>
                                       <div class="form-group">
                              <label for="email">Điểm thi lần 1</label>
                              <input type="text" name="diemthilan1" value="{{$data->diemthilan1}}" class="form-control" placeholder="nhâp điêm thi lân 1">
                            </div>
                            <div class="form-group">
                              <label for="email">Điểm thi lần 2</label>
                              <input type="text" name="diemthilan2" value="{{$data->diemthilan2}}" class="form-control" placeholder="nhâp điêm thi lân 2">
                            </div>
