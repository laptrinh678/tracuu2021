			...
			<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Ảnh</label>
					<div class="col-sm-9">
						<div id="div_1">
					       ...
					       <input type="file" required="" name="newimg" multiple="true" onchange="previewImg(event);" id="img_file" accept="image/*" value="{{$sliderid->img}}">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<textarea name="thongtin4" id="" cols="40" rows="2">{{$sliderid->thongtin4}}</textarea>
					</div>
				</div>
