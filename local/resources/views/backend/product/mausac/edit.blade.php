				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Sản phẩm</label>
					<div class="col-sm-3">
						...
						<select class="form-control" name="product_id" required="">
	                        ...
	                        <option value="{{$imgdeid->productmodel->id}}">{{$imgdeid->productmodel->pro_name}}</option>
				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Ảnh sản phẩm</label>
					<div class="col-sm-9">
						<div id="div_1">
					       ...
					       <input type="file" required="" name="new_imgdetail1" multiple="true" onchange="previewImg(event);" id="img_file" accept="image/*" value="{{$imgdeid->img}}">
					...
					<div class="col-sm-9">
						<div id="div_3">	
						 <div class="div_border">
							...
							<input type="file" required=""  name="new_imgdetail2" multiple="true" onchange="previewImg3(event);" id="img_file3" accept="image/*" value="{{$imgdeid->banve}}">
					...
					<div class="col-sm-9">
						<div id="div_2">	
						 <div class="div_border">
							...
							<input type="file" required=""  name="new_imgdetail3" multiple="true" onchange="previewImg2(event);" id="img_file2" accept="image/*" value="{{$imgdeid->duan}}">
